...
const styles = {
  base: [
	...
	sizes:{
		xs:'px-[calc(theme(spacing[2])-1px)] py-[calc(theme(spacing[1.5])-1px)] sm:px-[calc(theme(spacing[2.5])-1px)] sm:py-[calc(theme(spacing[1])-1px)] sm:text-xs rounded-sm',
		sm:'px-[calc(theme(spacing[3])-1px)] py-[calc(theme(spacing[2])-1px)] sm:px-[calc(theme(spacing[2.5])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] sm:text-sm rounded-md',
		md:'px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing.3)-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] sm:text-base rounded-lg',
		lg:'px-[calc(theme(spacing[4])-1px)] py-[calc(theme(spacing[3])-1px)] sm:px-[calc(theme(spacing[3.5])-1px)] sm:py-[calc(theme(spacing[2.5])-1px)] sm:text-lg rounded-xl',
		xl:'px-[calc(theme(spacing[5])-1px)] py-[calc(theme(spacing[4])-1px)] sm:px-[calc(theme(spacing[5])-1px)] sm:py-[calc(theme(spacing[3.5])-1px)] sm:text-xl rounded-2xl',
	},
  solid: [
    // Optical border, implemented as the button background to avoid corner artifacts
    'border-transparent bg-transparent',// bg-[--btn-border]',
  ...
  colors: {
    ...
    red: [
      ...
      '[--btn-icon:theme(colors.red.300)] data-[active]:[--btn-icon:theme(colors.red.200)] data-[hover]:[--btn-icon:theme(colors.red.200)] border-red-950/10',
    ],
    orange: [
    ...
    green: [
      'text-white [--btn-hover-overlay:theme(colors.black/10%)] [--btn-bg:theme(colors.green.600)] [--btn-border:theme(colors.green.700/90%)]',
...
export const Button = forwardRef(function Button(
  ...
  let classes = clsx(
    ...
    styles.base,
		styles.sizes[size],
    outline ? clsx(styles.outline, styles.colors[color ?? 'zinc']) : 
		plain ? styles.plain : clsx(styles.solid, styles.colors[color ?? 'green'])
  )
